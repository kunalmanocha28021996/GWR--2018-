...
public class Export_Firstjnpt extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.export_activity_firstjnpt);


        ListView listView=(ListView)findViewById(R.id.exportlistViewjnpt);
        populateList();
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int i, long id) {
                ...
                if(text=="PPSP")
                {
                    Intent inu = new Intent(Export_Firstjnpt.this,Export_FinalTableJNPT.class);
...
////////////////fff///fff///fff///////fff///////////////////////////
    ...
    public void move1(View view) {
        Intent inu = new Intent(Export_Firstjnpt.this, Export_JNPT.class);
        inu.putExtra("KEY","JNPT");
        startActivity(inu);
        finish();
    }
