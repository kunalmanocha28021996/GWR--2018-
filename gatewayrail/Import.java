...
public class Import extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button b1 = (Button) findViewById(R.id.ft);
        Button b2 = (Button) findViewById(R.id.fg);
        ...
        barChart.setOnChartValueSelectedListener(new OnChartValueSelectedListener() {
            ...
            public void onValueSelected(Entry e, int dataSetIndex, Highlight h) {
                float x = e.getXIndex();
                if(x==0){
                    Intent intu = new Intent (Import.this,Import2.class);
                    intu.putExtra("KEY",PPSP );
                    startActivity(intu);

                }
                if(x==1){
                    Intent intu = new Intent (Import.this,MDPT.class);
                    intu.putExtra("KEY",MDPT );
                    startActivity(intu);

                }
                if(x==2){
                    Intent intu1 = new Intent (Import.this,JNPT.class);
...
*/
        ...
        b1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Toast.makeText(Import.this, "ALREADY VIEWING GRAPH-VIEW", Toast.LENGTH_SHORT).show();
            }
        });
        ...
        b2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(Import.this, "OKAY", Toast.LENGTH_SHORT).show();
                Intent inu = new Intent(Import.this, TxtView.class);
                startActivity(inu);
                finish();
            }
        });
