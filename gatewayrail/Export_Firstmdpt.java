...
public class Export_Firstmdpt extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.export_activity_firstmdpt);


        ListView listView=(ListView)findViewById(R.id.exportlistViewmdpt);
        populateList();
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int i, long id) {
                ...
                if(text=="PPSP")
                {
                    Intent inu = new Intent(Export_Firstmdpt.this,Export_FinalTableMDPT.class);
...
////////////////fff///fff///fff///////fff///////////////////////////
    ...
    public void move1(View view) {
        Intent inuu = new Intent(Export_Firstmdpt.this, Export_MDPT.class);
        inuu.putExtra("KEY","MDPT");
        startActivity(inuu);
        finish();
    }
}
