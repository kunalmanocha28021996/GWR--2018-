...
public class Firstmdpt extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_firstmdpt);


        ListView listView=(ListView)findViewById(R.id.listViewmdpt);
        populateList();
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int i, long id) {
                ...
                if(text=="GHH")
                {
                    Intent inu = new Intent(Firstmdpt.this,FinalTableMDPT.class);
...
////////////////fff///fff///fff///////fff///////////////////////////
    ...
    public void move1(View view) {
        Intent inuu = new Intent(Firstmdpt.this, MDPT.class);
